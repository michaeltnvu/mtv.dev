...
const AltProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div className="bg-slate-200 p-2 mx-4 md:p-4 lg:flex lg:items-center lg:w-[60rem] xl rounded-md shadow-sm space-y-4">
      <img
        src={image}
        alt="project screenshot"
        className="lg:max-w-[50%] md:mx-auto p-1 shadow-sm"
      />
