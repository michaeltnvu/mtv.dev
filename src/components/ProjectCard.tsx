    ...
    <div className="flex shadow-xl">
      <div className="flex flex-col gap-4 p-10 justify-center text-center">
        ...
        <div className="flex gap-4 items-center justify-center">
          ...
          <Link to={sourceCode} target="_blank" className="hover:before:scale-x-100 hover:before:origin-left relative before:w-full before:h-1 before:origin-right before:transition-transform before:duration-300 before:scale-x-0 before:bg-indigo-500 before:absolute before:left-0 before:bottom-0">
              Source Code
          </Link>
        </div>
      </div>
      <img
        ...
        className="border h-[400px] w-[650px] shadow-md"
      />
    </div>
  );
};
